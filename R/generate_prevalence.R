...
#' @examples
#' generate_prevalence(z = -1, method = "proportion", two.tailed = TRUE, dp = 5)
#' generate_prevalence(z = -1, method = "proportion", two.tailed = FALSE, dp = 5)
#' @export
generate_prevalence <- function(z, method = "proportion", two.tailed = FALSE, dp = 5) {
