...
#'
#'@param score Numeric value (or vector) containing the index scores to be
...
#'
#' @return A character vector containing the qualitative descriptors (e.g., "Low", "Average", "High") corresponding to the input test scores based on the selected descriptor system.
#'
#' @examples
...
#'
#' Convert z scores to descriptors using the WAIS descriptor system
#' generate_descriptor(score = c(-1.5, 0, 1.5), metric = "z", system = "wais")
#'
#'#' @references
