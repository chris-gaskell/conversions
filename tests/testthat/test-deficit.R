...
test_that("deficit function works correctly", {
  result <- deficit(score = 130, ctrl.mean = 100, ctrl.n = 30, ctrl.sd = 15)
...
test_that("deficit function works correctly", {
  result <- deficit(ctrl.m = 12.78, ctrl.sd = 3.45, ctrl.n = 16, score = 4.0, conf.level = .05, direction = "lower", dp = 2)
